...
seats = col2.selectbox("Select the number of seats", [4, 5, 7, 9, 11])

#input_features = [[2018.0, 1, 4000, fuel_type, transmission_type, 19.70, engine, 86.30, seats]]
encode_dict = {
    "fuel_type": {"Diesel":1, "Petrol":2, "CNG":3, "LPG":4, "Electric":5},
    "seller_type": {"Dealer": 1, "Individual": 2, "Truestmark Dealer": 3},
...
if st.button("Predict Price"):
    ...
    price = model_pred(fuel_type, transmission_type, engine, seats)[0]

    st.text(f"The price of the cars is {price:.2f} lakhs rupees")